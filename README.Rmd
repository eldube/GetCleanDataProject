...
A brief description of each file in the repository is given below:
 ...
 - **CodeBook.md** - Explains how the data was consolidated from several text files into a single dataset
 
 - **run_analysis.R** - the R scripts containing the commands used to get the data, process it, and merge into a single file.
...
The **run_analysis.R** will also create the following support files and folders in the working directory

- **projData.zip** - the downloade compressed file containing the original dataset.
...
*Other files in the repository include the .Rmd  and .html files used to generate the .md files using R markdown and  knitr. To view the files you only need to open the .md files.*
